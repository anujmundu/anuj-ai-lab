...
STOPWORDS = {
    ...
    "don't", "down", "during", "each", "few", "for", "from", "further", "had", "has", "have",
    "having", "he", "her", "here", "hers", "herself", "him", "himself", "his", "how", "i",
    "if", "in", "into", "is", "it", "its", "itself", "just", "let's", "me", "more", "most",
    ...
    "why", "with", "would", "you", "your", "yours", "yourself", "yourselves", "including",
    "summary", "example", "using", "used", "well", "make", "like", "will", "may", "might",
    "overall", "based", "first", "second", "third", "one", "two", "three", "four", "five",
    "better", "best", "step", "steps", "due", "help", "helps", "provides", "provide",
}
